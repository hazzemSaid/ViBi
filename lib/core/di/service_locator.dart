...
Future<void> setupServiceLocator(SharedPreferences prefs) async {
  ...
  getIt.registerLazySingleton<GraphQLInboxDataSource>(GraphQLInboxDataSource.new);

  getIt.registerLazySingleton<GraphQLFollowDataSource>(GraphQLFollowDataSource.new);
