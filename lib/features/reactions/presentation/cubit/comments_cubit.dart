...
export 'package:vibi/features/reactions/presentation/cubit/comments_state.dart';
...
class CommentsCubit extends Cubit<CommentsState> {
  ...
  Future<void> load(String answerId) async {
    try {
      emit(
        CommentsLoading(comments: state.comments, isSending: state.isSending),
      );
  ...
  Future<void> addComment({
    ...
    try {
      ...
      emit(CommentsFailure('$e', comments: currentComments, isSending: false));
    }
  }
}
